...
ARCHIVE = ROOT / "dist" / "narwal-cloud-eu-0.10.0.zip"
...
def test_release_archive_matches_component_tree() -> None:
    ...
    with zipfile.ZipFile(ARCHIVE) as archive:
        ...
        assert "custom_components/narwal_cloud/translations/da.json" in names
        assert "custom_components/narwal_cloud/translations/ko.json" not in names
